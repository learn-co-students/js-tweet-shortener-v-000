...
describe('tweetShortener', function() {
  ...
  it('shortens tweets in bulk', function(){
    ...
    var shortenedTweets = [tweet_one_short, tweet_two_short, tweet_three_short, tweet_four_short, tweet_five_short];
    expect(tweetShortener.bulkShortener(tweets)).toEqual(shortenedTweets);
  });
